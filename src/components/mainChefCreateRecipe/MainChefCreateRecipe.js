...
import { cuisineList, dietsList } from "./mainChefCreateRecipeData";
      ...
      <div className="mainChefCreateRecipe">
        <div className="mainChefCreateRecipe__container">
          ...
          <div className="mainChefCreateRecipe__tools">
            <h5>
              Required tools<span className="optional">(optional)</span>
            </h5>
            <textarea
              name="requiredTools"
              value={requiredTools}
              onChange={handleChange}
              rows="7"
              placeholder="Write tools needed to cook this"
            />
          </div>
          ...
          <div className="mainChefCreateRecipe__buttons">
            <Button onClick={openModal1} className="the-cancel-button">
              Cancel
            </Button>
            <Button onClick={handleSubmit} className="the-post-button">
              Post
            </Button>
          </div>
        </div>

            ...
            <div className='feedMaster__container'>
                ...
                <div className='class__details'>
                    ...
                    <div className='class__details__right'>
                        <p>Come and enjoy cooking the yummiest
                            Pizza you have ever seen
                        </p>
                        <p className='ingredients'><span>Ingredients:</span> pepper, flour, orange juice</p>
                        <div className='class__receipt'>
                            <p className='class__cost'><span>$</span> 25 </p>
                            <p>|</p>
